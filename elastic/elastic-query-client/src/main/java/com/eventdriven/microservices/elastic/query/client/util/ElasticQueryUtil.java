package com.eventdriven.microservices.elastic.query.client.util;
...
public class ElasticQueryUtil<T extends IndexModel> {
    ...
    {
        return new NativeSearchQueryBuilder().withQuery(new
                BoolQueryBuilder().must(QueryBuilders.matchQuery(field,text)))
                .build();
    }
