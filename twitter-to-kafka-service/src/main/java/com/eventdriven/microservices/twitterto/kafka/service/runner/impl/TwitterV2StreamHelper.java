package com.eventdriven.microservices.twitterto.kafka.service.runner.impl;

import com.eventdriven.microservices.config.TwitterToKafkaConfigData;
import com.eventdriven.microservices.twitterto.kafka.service.listener.TwitterKafkaStatusListener;
...
public class TwitterV2StreamHelper {
    ...
    public TwitterV2StreamHelper(TwitterToKafkaConfigData twitterToKafkaConfigData,
    ...
    void connectStream(String bearerToken) throws IOException, URISyntaxException, JSONException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterToKafkaConfigData.getTwitterV2BaseUrl());
    ...
    private void createRules(String bearerToken, Map<String, String> rules) throws URISyntaxException, IOException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterToKafkaConfigData.getTwitterV2RulesBaseUrl());
